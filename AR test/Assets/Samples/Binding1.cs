...
using UnityEngine;
    ...
    /// <summary>
    /// The class that stores a mapping between a <see cref="FaceShapeBlend"/> and a mesh blend shape.
    /// </summary>
    [Serializable]
    class Binding1
    {
        [SerializeField]
        FaceShapeBlend m_Location = FaceShapeBlend.Invalid;
        [SerializeField]
        int m_ShapeIndex = -1;
        [SerializeField]
...
#pragma warning restore CS0414
        ...
        /// </summary>
        public FaceShapeBlend Location => m_Location;
        ...
        public Binding(FaceShapeBlend location, int shapeIndex, BindingConfig config, bool isExpanded)
        {
            m_Location = location;
